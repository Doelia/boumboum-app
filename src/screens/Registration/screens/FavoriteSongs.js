    ...
    <>
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flex: 1, paddingHorizontal: CONTENT_PADDING, paddingVertical: 15 }}>
          ...
          >
            <Text style={{ flex: 1, ...STYLES.FONT_INPUT }}>
              {!maxSongsReached ? 'Add a new song...' : 'Remove a song before adding a new one'}
            </Text>
            <Image
              source={IMAGES.icons.search}
              style={{ width: 80 / 2, height: 80 / 2, marginVertical: 5 }}
            />
          </TouchableOpacity>
                  ...
                  icon={() => (
                    <TouchableOpacity onPress={() => removeSong(song.title)}>
                      <Image
                        ...
                        style={{ width: 48 / 2, height: 48 / 2, margin: 5 }}
                      />
                    </TouchableOpacity>
                  )}
                />
