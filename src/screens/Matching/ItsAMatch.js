                ...
                <View style={{alignItems: 'center'}}>
                    ...
                    <View style={{flexDirection: 'row', height: 494 / 2, width: '100%'}}>
                        <Animated.View style={{flex: 1, transform: [{translateX: translateXInner}]}}>
                            <Animated.Image source={IMAGES.matching.vinyl} style={{ ...styles.image_vinyl, right: 0, transform: [{rotate: revertedRotate}] }}/>
                            <Animated.Image source={IMAGES.matching.tonearm} style={{ ...styles.image_tonearm, right: 100, transform: [{rotate: rotateArm}] }}/>
                            <Animated.Image source={photoMe} style={{ ...styles.image_profile, right: 85, transform: [{rotate: revertedRotate}] }}/>
                        </Animated.View>
                        <Animated.View
                            style={{flex: 1, transform: [{translateX: Animated.multiply(translateXInner, -1)}]}}>
                            <Animated.Image source={IMAGES.matching.vinyl} style={{ ...styles.image_vinyl, left: 0, transform: [{rotate}, {scaleX: -1}] }}/>
                            <Animated.Image source={IMAGES.matching.tonearm} style={{ ...styles.image_tonearm, left: 100, transform: [{scaleX: -1}, {rotate: rotateArm}] }}/>
                            <Animated.Image source={photoMatched} style={{ ...styles.image_profile, left: 85, transform: [{rotate}] }}/>
                        </Animated.View>
                    </View>
                </View>
            </View>
